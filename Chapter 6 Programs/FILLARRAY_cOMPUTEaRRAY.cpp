...
void fillArray(int grade[][NUMBER_QUIZZES], int NUMBER_STUDENTS);
...
{	
	...
	fillArray (grade, NUMBER_STUDENTS);
...
void fillArray(int grade[][NUMBER_QUIZZES], int NUMBER_STUDENTS)
{
	...
	for (int index1 = 0; index1 < NUMBER_STUDENTS; index1++)
 	{
 		for (int index2 = 0; index2 < NUMBER_QUIZZES; index2++)
 		{
 		cout << "Enter student " << (index1 + 1) << " grade for quiz " << (index2 + 1) << ": ";
